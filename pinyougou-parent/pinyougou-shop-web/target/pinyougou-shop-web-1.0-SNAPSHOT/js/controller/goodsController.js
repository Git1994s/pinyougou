...
app.controller('goodsController', function ($scope, $controller, goodsService, uploadService, itemCatService, typeTemplateService, $location) {
    ...
    $scope.findOne = function () {
        ...
        goodsService.findOne(id).success(
            function (response) {
               ...
               /* if($scope.entity.goodsDesc.introduction !=null){
                    editor.html($scope.entity.goodsDesc.introduction);
                }else {
                    alert("走这里");
    ...
    //保存
    $scope.save = function () {
        $scope.entity.goodsDesc.introduction = editor.html();//提取编辑器内容
    ...
    //保存选择的选项  $event 取消勾选 name(网络) value(电信2G)
    ...
    $scope.createItemList = function () {
        //初始值
        $scope.entity.itemList = [{spec: {}, price: 0, num: 201901, status: '0', isDefault: '0'}];
